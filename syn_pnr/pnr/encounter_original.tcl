...
set init_lef_file "$env(TECH_LEF) $env(LIB_LEF) $env(SRAM_LEF)" ;# Load LEF(Library Exchange Format) Files
...
editPin -snap TRACK -side INSIDE -layer 6 -assign 385 0 -pin rst_n
editPin -snap TRACK -side INSIDE -layer 6 -assign 445 0 -pin clk
